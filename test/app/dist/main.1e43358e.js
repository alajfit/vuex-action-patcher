...
exports.default = _default;
  ...
  return _c("div", { staticClass: "demo" }, [
    _c("h1", [_vm._v(_vm._s(_vm.name) + " Demo")]),
    _vm._v(" "),
    _c("button", { on: { click: _vm.updateTime } }, [_vm._v("Click")]),
    _vm._v(" "),
    _c("h2", [
      _vm._v("Time since start of day " + _vm._s(_vm.timeSinceStartOfDay))
    ])
  ])
}
var staticRenderFns = []
...
},{}],"../../src/utils/patchAction/index.js":[function(require,module,exports) {
"use strict";
...
function patchAction(_ref) {
  ...
  entry.push(function (payload, cb) {
    ...
    var res = handler(context, payload, cb);
    if (!_index.default.isPromise(res)) res = Promise.resolve(res);
    return store._devtoolHook ? res.catch(function (err) {
      store._devtoolHook.emit('vuex:error', err);
...
},{"../index":"../../src/utils/index.js"}],"../../src/utils/patchModule/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = patchModule;
...
function patchModule(_ref) {
  ...
  var local = module.context; // Patch the current Actions context for this module

  module.forEachAction(function (action, key) {
    return _index.default.patchAction({
      store: store,
      type: namespace + key,
      handler: action,
      local: local,
...
},{"../index":"../../src/utils/index.js"}],"../../src/utils/index.js":[function(require,module,exports) {
"use strict";
...
var _patchAction = _interopRequireDefault(require("./patchAction"));

var _patchModule = _interopRequireDefault(require("./patchModule"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _default = {
  isPromise: _isPromise.default,
  patchAction: _patchAction.default,
  patchModule: _patchModule.default
};
exports.default = _default;
},{"./isPromise":"../../src/utils/isPromise/index.js","./patchAction":"../../src/utils/patchAction/index.js","./patchModule":"../../src/utils/patchModule/index.js"}],"../../src/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = vuexActionPatcher;
...
function _default() {
  return new _vuex.default.Store({
    ...
    actions: {
      setTime: function setTime(_ref) {
        var commit = _ref.commit,
            moment = _ref.moment;
        var timeSSOD = moment().startOf('day').fromNow();
        commit('setTime', timeSSOD);
      }
    },
    mutations: {
      setTime: function setTime(state, payload) {
