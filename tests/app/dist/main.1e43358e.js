...
//
var _default = {
  computed: (0, _vuex.mapState)(['name'])
};
exports.default = _default;
...
module.exports = {
  ...
  "scripts": {
    ...
    "demo": "parcel test/app/index.html --out-dir tests/app/dist",
...
function vuexActionPatcher(Vuex, tools) {
  return function (store) {
    ...
    var orig = Vuex.Store.prototype.registerModule;

    Vuex.Store.prototype.registerModule = function registerModule(path, rawModule) {
      orig.call(this, path, rawModule);

      _utils.default.patchModule(this, [].concat(path), this._modules.get([path]));
    };
  };
}
